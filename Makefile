...
tailwind-watch: ## compile tailwindcss and watch for changes
	npx @tailwindcss/cli -i ./internal/static/css/input.css -o ./internal/static/css/style.css --watch

.PHONY: tailwind-build
tailwind-build: ## one-time compile tailwindcss styles
	npx @tailwindcss/cli -i ./internal/static/css/input.css -o ./internal/static/css/style.css
